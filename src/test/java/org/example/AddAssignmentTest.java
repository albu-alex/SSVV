...
public class AddAssignmentTest
{
    ...
    @Test
    public void testAddTema_ValidTema() {
    ...
    @Test
    public void testAddTema_InvalidTema_NullId() {
        assertEquals(1, service.saveTema(null, "Alex", 10, 6));
    }

    @Test
    public void testAddTema_InvalidTema_StartlineLargerThanDeadline() {
        assertEquals(1, service.saveTema("2", "Alex", 10, 11));
    }

    @Test
    public void testAddTema_ValidTema_StartlineBeforeDeadline() {
    ...
    @Test
    public void testAddTema_InvalidTema_Startline_0() {
        assertEquals(1, service.saveTema("22", "aa", 2, 0));
    }

    @Test
    public void testAddTema_ValidTema_Deadline_13() {
    ...
    @Test
    public void testAddTema_InvalidTema_Deadline_15() {
        assertEquals(1, service.saveTema("24", "aa", 15, 12));
    }

    @Test
    public void testAddTema_InvalidTema_Startline_and_Deadline_negative() {
        assertEquals(1, service.saveTema("25", "aa", -2,-1));
    }

    @Test
    public void testAddTema_InvalidTema_Startline_20_and_Deadline_25() {
        assertEquals(1, service.saveTema("26", "aa", 25, 20));
    }

    @Test
    public void testAddTema_InvalidTema_Id_emptyString() {
        assertEquals(1, service.saveTema("", "aa", 6,5));
    }

    @Test
    public void testAddTema_Descriere_emptyString() {
